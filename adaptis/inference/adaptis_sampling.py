...
def get_panoptic_segmentation(pmodel, image, ignore_mask=None, use_flip=True, crop_size=None, min_overlap=0.2, stuff_prob_mult=1.0, min_things_prob=0.0, min_stuff_prob=0.0,
