...
def get_unet_model(channel_width=32, max_width=512, with_proposals=False, rescale_output=(0.2, -1.7), norm_layer=nn.BatchNorm2d, num_classes=2):
    unet = UNet(
        num_blocks=4,
    ...
    return AdaptIS(
        ...
        segmentation_head=basic_blocks.ConvHead(num_classes*2, in_channels=in_channels, num_layers=3, norm_layer=norm_layer),
